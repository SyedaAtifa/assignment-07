  ...
  return (
    <div className="bg-[#85c1e4]">
      ...
      {parsedResponse.map ((books) => (
       <div className="">
          <div  className="h-[180px] border rounded-[10px] m-6 flex flex-col gap-2 justify-center items-center text-[#474747] text-xl bg-[#e6dddd] transition-transform duration-100 hover:scale-110 shadow-xl">
            <p>Book: {books.id}</p>
